...
import PicCake from './GenCanvasPlug/PicCake';
//图片选择器
...
export default class CameraTest extends Component {
    ...
    render() {
        const finalImg = this.state.hasImgLoad ?
            <PicCake ref='piccake' url={this.state.avatarSource} hasImgGened={this.state.hasImgGened} data={this.state.dataImg} time={this.state.timePoint}
